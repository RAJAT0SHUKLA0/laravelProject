...
@extends('frontend.FrontLayout.layout')
@section("content")

 
<!-- buying easy way tips -->
 <div class="buying-easyway-process">
        <div class="container-2">
            <div class="col-lg-12">
                <!-- wasy-way buying area -->
                <div class="easyway-buying-area-wrapper">
                    <!-- single easyway buying area start -->
                    <div class="single-easy-way-buying-area">
                        <div class="icon">
                    ...
                    <!-- single easy way buying area end -->
                    <!-- single easyway buying area start -->
                    <div class="single-easy-way-buying-area">
                        <div class="icon">
    ...
    <div class="rts-category-area rts-section-gapTop">
        <div class="container-2">
            ...
            @php
            $categoryCount = count($Category); // Get the number of categories
            $swiperSlides = 7; // Default value for large screens

            // Adjust slides per view based on the category count
            if ($categoryCount <= 2) {
                $swiperSlides = 2;
                        ...
                        <div class="col-lg-12">
                            <div class="category-area-main-wrapper-one">
                                <div class="swiper mySwiper-category-1 swiper-data" data-swiper='{
                                    ...
                                    "breakpoints": {
                                        "0": {
                                            "slidesPerView": {{ $categoryCount <= 2 ? 2 : 1 }},
                                            "spaceBetween": 12
                                        },
                                        "320": {
                                            "slidesPerView": {{ $categoryCount <= 2 ? 2 : 1 }},
                                        ...
                                        "480": {
                                            "slidesPerView": {{ $categoryCount <= 3 ? 3 : 2 }},
                                            "spaceBetween": 12
                                        },
                                        "640": {
                                            "slidesPerView": {{ $categoryCount <= 4 ? 4 : 3 }},
                                            "spaceBetween": 12
                                        },
                                        "840": {
                                            "slidesPerView": {{ $categoryCount <= 6 ? 6 : 4 }},
                                            "spaceBetween": 12
                                        },
                                        "1140": {
                                            "slidesPerView": {{ $swiperSlides }},
                                                ...
                                                <div class="swiper-slide">
                                                    <div class="single-category-one">
                                                        <a href="shop-grid-sidebar.html">
                                                            <img src="{{ asset($cat->image)}}" alt="category">
                                                            <p>{{$cat->name}}</p>
                                                        </a>
                                                    </div>
                                                </div>
        ...
        <div class="container-2">
            <div class="row g-24">
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="single-feature-card ssthree style-three bg_image one">
                        <div class="content-area">
                            <a href="shop-grid-top-filter.html" class="rts-btn btn-primary">Weekend Discount</a>
                            <h3 class="title">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="single-feature-card ssthree style-three bg_image two">
                        <div class="content-area">
                            <a href="shop-grid-top-filter.html" class="rts-btn btn-primary">Weekend Discount</a>
                            <h3 class="title">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="single-feature-card ssthree style-three bg_image three">
                        <div class="content-area">
                            <a href="shop-grid-top-filter.html" class="rts-btn btn-primary">Weekend Discount</a>
                            <h3 class="title">
