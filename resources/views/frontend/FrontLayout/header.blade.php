...
<!-- Mirrored from html.themewant.com/ekomart/index-three.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 18 Oct 2024 10:35:30 GMT -->
<head>
    <meta charset="UTF-8">
    ...
    <!-- plugins css -->
    <link rel="stylesheet preload" href="{{url('frontend/assets/css/plugins.css')}}" as="style">
    <link rel="stylesheet preload" href="{{url('frontend/assets/css/style.css')}}" as="style">
                    ...
                    <div class="col-lg-12">
                        <div class="logo-search-category-wrapper">
                            <a href="index-2.html" class="logo-area">
                                <img src="{{url('frontend/assets/images/logo/logo-02.svg')}}" alt="logo-main" class="logo">
                            </a>
                            <div class="category-search-wrapper">
                                <div class="category-btn category-hover-header">
                                    <img class="parent" src="{{url('frontend/assets/images/icons/bar-1.svg')}}" alt="icons">
                                    <span>Categories</span>
                                    <ul class="category-sub-menu" id="category-active-four">
                                        <li>
                                            <a href="#" class="menu-item">
                                                <img src="{{url('frontend/assets/images/icons/01.svg')}}" alt="icons">
                                        ...
                                        <li>
                                            <a href="#" class="menu-item">
                                                <img src="{{url('frontend/assets/images/icons/02.svg')}}" alt="icons">
                                        ...
                                        <li>
                                            <a href="#" class="menu-item">
                                                <img src="{{url('frontend/assets/images/icons/03.svg')}}" alt="icons">
                                                <span>Breads &amp; Bakery</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#" class="menu-item">
                                                <img src="{{url('frontend/assets/images/icons/04.svg')}}" alt="icons">
                                        ...
                                        <li>
                                            <a href="#" class="menu-item">
                                                <img src="{{url('frontend/assets/images/icons/05.svg')}}" alt="icons">
                                                <span>Medical Healthcare</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#" class="menu-item">
                                                <img src="{{url('frontend/assets/images/icons/06.svg')}}" alt="icons">
                                                <span>Breads &amp; Bakery</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#" class="menu-item">
                                                <img src="{{url('frontend/assets/images/icons/07.svg')}}" alt="icons">
                                        ...
                                        <li>
                                            <a href="#" class="menu-item">
                                                <img src="{{url('frontend/assets/images/icons/08.svg')}}" alt="icons">
                                                <span>Frozen Foods</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#" class="menu-item">
                                                <img src="{{url('frontend/assets/images/icons/09.svg')}}" alt="icons">
                                                <span>Grocery &amp; Staples</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#" class="menu-item">
                                                <img src="{{url('frontend/assets/images/icons/10.svg')}}" alt="icons">
    ...
    <nav>
        <ul class="parent-nav">
            ...
            <li class="parent"><a href="contact.html">Contact</a></li>
                        ...
                        <div class="logo-search-category-wrapper">
                            <a href="index-2.html" class="logo-area">
                                <img src="{{asset('images/logo/logo-01.svg')}}" alt="logo-main" class="logo">
                            </a>
                            <div class="category-search-wrapper">
                                <div class="category-btn category-hover-header">
                                    <img class="parent" src="{{asset('images/icons/bar-1.svg')}}" alt="icons">
                                    <span>Categories</span>
